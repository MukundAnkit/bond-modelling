...
class MonteCarloEngine:
    ...
    def simulate_paths(self, r0: typing.Union[float, typing.Tuple[float, float]], T: float) -> np.ndarray:
        ...
        model_name = self.model.__class__.__name__ if hasattr(self.model, "__class__") else ""
        ...
        for t in range(1, self.n_steps + 1):
            ...
            if model_name == "HullWhite2FModel":
                ...
                dW1 = Z1 * sqrt_dt
                dW2 = (self.model.rho * Z1 + np.sqrt(1 - self.model.rho**2) * Z2) * sqrt_dt
            ...
            if model_name == "CIRModel":
                ...
                drift = (self.model.theta - self.model.a * np.log(x_prev_safe)) * x_prev_safe * dt
    ...
    def price_zcb(self, r0: typing.Union[float, typing.Tuple[float, float]], T: float) -> float:
